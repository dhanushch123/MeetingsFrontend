...
function Eventlist({success,setSuccess,user,isMobile,setActiveComponent}) {
    ...
    async function fetchDetails(){
        try{
            ...
            let request = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/event/getEvents`,{withCredentials : true})
        ...
        {arr.map((item,index)=>{
            ...
            src={Exclam}/> <div> Conflict of timing </div> 
                    ...
                    <div  className={styles.dwn}> <img onClick={async ()=>{
                        ...
                        try{
                            let request = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/event/status/${item._id}`,{},{withCredentials : true})
                     ...
                     <img onClick={async()=>{
                        ...
                        try{
                            let request = await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/event/remove/${item._id}`,{withCredentials : true})
